...
class TestAddressMasking:
    def test_shows_only_last_four(self):
        addr = "0x1234567890abcdef1234567890abcdef1234c0de"
        masked = _mask(addr)
        assert masked == "0x…c0de"
    ...
    def test_full_address_not_in_masked(self):
        ...
        assert "12345678" not in masked         # leading bytes gone
    ...
    def test_lowercased(self):
        addr = "0x1234567890ABCDEF1234567890ABCDEF1234C0DE"
        masked = _mask(addr)
        assert masked == "0x…c0de"   # last 4 lowercased
